...
const WHEEL_CIRCUMFERENCE = Math.PI * WHEEL_RADIUS_SQUARED
...
export default class Machine {
  ...
  beginLoading = () => {
    ...
    this.xp0 = this.suite.getUserX(this.xo)
    this.yp0 = this.suite.getUserY(this.yo)
  }
  ...
  updPos = () => {
    // get new position
    this.xp1 = this.suite.getUserX()
    this.yp1 = this.suite.getUserY()
